...
VENUE_SETUP_GUIDES = {
    ...
    "hyperliquid": [
        "Usar mainnet para operacao real: DEX_ID=hyperliquid, HYPERLIQUID_NETWORK=mainnet e HYPERLIQUID_SANDBOX=false.",
        HYPERLIQUID_MARKET_TYPE_REFERENCE,
        DEX_MARKET_TYPE_REFERENCE,
    ...
    "binance": [
        ...
        "Definir CEX_SANDBOX=true se for testnet/sandbox; false apenas depois de validado.",
    ...
    "kraken": [
        ...
        "Definir KRAKEN_VENUE/CEX_MARKET_TYPE e KRAKEN_SANDBOX/CEX_SANDBOX conforme ambiente; KRAKEN_API_IS_SUBACCOUNT so se a key realmente for de subconta.",
    ...
    "bybit": [
        ...
        "Definir CEX_SANDBOX=true para testnet quando aplicavel.",
        "Rodar venues, cex-accounts, symbols e dry-run antes de live.",
    ],
    "okx": [
        ...
        "Definir CEX_SANDBOX=true se for ambiente demo/sandbox.",
        "Rodar venues, cex-accounts, symbols e dry-run antes de live.",
    ],
    "kucoin": [
        ...
        "Definir CEX_SANDBOX=true apenas se estiver usando sandbox/testnet compativel.",
        "Rodar venues, cex-accounts, symbols e dry-run antes de live.",
    ],
    "mexc": [
        ...
        "Definir CEX_SANDBOX conforme o ambiente real da conta/API.",
        "Rodar venues, cex-accounts, symbols e dry-run antes de live.",
    ],
    "bitget": [
        ...
        "Definir CEX_SANDBOX=true apenas se estiver usando ambiente demo/sandbox compativel.",
        "Rodar venues, cex-accounts, symbols e dry-run antes de live.",
    ],
    "gateio": [
    ...
    "outras_cex_ccxt": [
        ...
        "Definir CEX_ID=<exchange_id>, CEX_MARKET_TYPE=trade|future|spot e CEX_SANDBOX=true|false; trade normaliza para CCXT swap.",
...
VENUE_CREDENTIAL_REQUIREMENTS = {
    ...
    "hyperliquid": {
        ...
        "config_envs": ["HYPERLIQUID_NETWORK=mainnet", "HYPERLIQUID_SANDBOX=false", "DEX_MARKET_TYPE=trade (fallback DEX amigavel)", "HYPERLIQUID_MARKET_TYPE=trade (alias especifico; normaliza para CCXT swap)", "HYPERLIQUID_SYMBOL_QUOTE=USDT"],
    ...
    "kraken": {
        ...
        "config_envs": ["KRAKEN_VENUE=futures|spot", "KRAKEN_SANDBOX=true|false", "CEX_MARKET_TYPE=trade|future|spot (Kraken: trade normaliza para futures; CEX CCXT: trade normaliza para swap)", "KRAKEN_REQUIRE_SUBACCOUNT=false por padrao"],
    ...
    "binance": {
        ...
        "config_envs": ["CEX_MARKET_TYPE=trade|future|spot (trade normaliza para CCXT swap)", "CEX_SANDBOX=true|false"],
    ...
    "bybit": {
        ...
        "optional_envs": ["CEX_OPTIONS_JSON"],
        "config_envs": ["CEX_MARKET_TYPE=trade|spot (trade normaliza para CCXT swap)", "CEX_SANDBOX=true|false"],
        "where_to_save": "secret manager > Chaves de Serviço",
    },
    "okx": {
...
DISCORD_DELIVERY_STATE = {
    ...
    "bot_installed": None,
    "token_saved": None,
    "channel_id_saved": None,
    "format": "embed_nativo",
    "mention": "none",
    "image_policy": "sem_imagem",
    "path": "setup-live",
    "validation_required": ["setup-check", "doctor", "dry-run"],
}

DISCORD_DELIVERY_GUIDANCE = {
    "reference": "doc referencia/05-entrega-discord-zeus.md",
    "purpose": "Configurar copia Discord no padrao Zeus sem pedir token ou segredo no chat.",
    "required_secret_envs": ["DISCORD_BOT_TOKEN"],
    "required_config_envs": ["SETUP_NOTIFY_ENTRY_DISCORD_CHANNEL_ID"],
    ...
    "wizard_rules": [
        ...
        "Nunca pedir DISCORD_BOT_TOKEN no chat; pedir apenas confirmacao de que foi salvo no Secret Manager/env seguro.",
        "Canal ID nao e segredo, mas deve comecar em canal de teste.",
        "Validar setup-check, doctor e rodar-setups-live --simular --max-iter 1 antes de live/publico.",
        "Texto/embed estruturado e a fonte da verdade; imagem e opcional e desativada por padrao.",
    ],
    "question_flow": [
        {
            "field": "discord_delivery.enabled",
            "question": "Quer configurar copia Discord no padrao Zeus agora, deixar para depois ou nao usar Discord?",
            "options": ["configurar_agora", "depois", "nao_usar"],
            "default": "depois",
        },
        {
            "field": "discord_delivery.stage",
            "question": "A entrega Discord vai primeiro para canal de teste ou canal publico?",
            "options": ["teste", "publico"],
            "default": "teste",
        },
        {
            "field": "discord_delivery.bot_installed",
            "question": "O bot do Zeus ja esta no servidor/canal? Responda sim, nao ou nao sei.",
            "options": ["sim", "nao", "nao_sei"],
        },
        {
            "field": "discord_delivery.token_saved",
            "question": "O DISCORD_BOT_TOKEN ja esta salvo no env/Secret Manager seguro? Nao cole o token no chat.",
            "options": ["sim", "nao", "nao_sei"],
        },
        {
            "field": "discord_delivery.channel_id_saved",
            "question": "O SETUP_NOTIFY_ENTRY_DISCORD_CHANNEL_ID ja esta salvo ou voce tem o ID do canal de teste?",
            "options": ["sim", "nao", "nao_sei"],
        },
        {
            "field": "discord_delivery.format",
            "question": "Qual formato usar no primeiro teste Discord?",
            "options": ["embed_nativo", "texto_caixa", "texto_citacao", "texto_puro"],
            "default": "embed_nativo",
        },
        {
            "field": "discord_delivery.mention",
            "question": "Deve mencionar @everyone no Discord? Recomendo nao mencionar no primeiro teste.",
...
DEFAULT_PAYLOAD = {
    ...
    "discord_delivery_reference": "doc referencia/05-entrega-discord-zeus.md",
    "discord_delivery_guidance": DISCORD_DELIVERY_GUIDANCE,
    ...
    "question_strategy": {
        ...
        "discord_delivery_user_decides": True,
        "discord_delivery_default_stage": "teste",
    },
    ...
    "question_flow": [
        ...
        {
            "field": "discord_delivery",
            "reason": "Define se a instalacao deve guiar a copia Discord no padrao Zeus, sem receber token no chat.",
            "question": "Quer configurar a entrega Discord/Zeus agora, deixar para depois ou nao usar Discord? Se configurar agora, vou seguir o checklist do canal de teste e pedir apenas status do token/canal, nunca o token.",
            "options": ["configurar_agora", "depois", "nao_usar"],
            "default": "depois",
            "reference": "doc referencia/05-entrega-discord-zeus.md",
            "requires_secret_env": "DISCORD_BOT_TOKEN",
            "requires_config_env": "SETUP_NOTIFY_ENTRY_DISCORD_CHANNEL_ID",
        },
        {
    ...
    "state": {
        ...
        "discord_delivery": DISCORD_DELIVERY_STATE.copy(),
        "next_safe_step": "venues+setup-check+doctor",
        "questionnaire_completed": False,
    },
    "final_confirmation_template": "Plano: DEX {dex_id}, CEX {cex_id}, modo {execution_mode}, ambiente {environment}, contas/envs {account_and_secrets_status}, sizing {sizing}, margem {margin_mode}, stop por alvo {target_stop_mode}, Discord/Zeus {discord_delivery}. Próximo passo seguro: venues + setup-check + doctor, sem trade. Confirmo?",
}
